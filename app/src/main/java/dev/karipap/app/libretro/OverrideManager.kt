...
import dev.karipap.app.input.runtime.CanonicalRetroMap
...
class OverrideManager(
    ...
    data class Settings(
        ...
        var shortcuts: Map<ShortcutAction, Set<Int>> = defaultShortcuts,
    ...
    companion object {
        private val menuChord = setOf(KeyEvent.KEYCODE_BUTTON_SELECT, KeyEvent.KEYCODE_BUTTON_START)
        val defaultShortcuts: Map<ShortcutAction, Set<Int>> = mapOf(
            ShortcutAction.OPEN_MENU to menuChord,
            ShortcutAction.SAVE_STATE to setOf(KeyEvent.KEYCODE_BUTTON_SELECT, KeyEvent.KEYCODE_BUTTON_R1),
            ShortcutAction.LOAD_STATE to setOf(KeyEvent.KEYCODE_BUTTON_SELECT, KeyEvent.KEYCODE_BUTTON_L1),
            ShortcutAction.TOGGLE_FF to setOf(KeyEvent.KEYCODE_BUTTON_SELECT, KeyEvent.KEYCODE_DPAD_DOWN),
            ShortcutAction.SHOW_FPS to setOf(KeyEvent.KEYCODE_BUTTON_SELECT, KeyEvent.KEYCODE_BUTTON_X),
        )
    }
}
