...
import dev.karipap.app.input.EditButtonsController
...
class EditButtonsInputHandler @Inject constructor(
    ...
    private val portRouter: dev.karipap.app.input.runtime.PortRouter,
    private val activeMappingHolder: dev.karipap.app.input.runtime.ActiveMappingHolder,
) : ScreenInputHandler {
