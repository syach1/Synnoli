...
class AndroidDefaultMappingFactoryTest {
    ...
    private val defaultHints = dev.karipap.app.input.hints.ControllerHintTable.fromJson(
    ...
    fun btn_menu_defaults_to_back_and_mode_keycodes() {
        ...
        val keys = menu.filterIsInstance<dev.karipap.app.input.InputBinding.Button>().map { it.keyCode }
